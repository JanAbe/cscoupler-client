  ...
  <div class="mt-4 md:mt-8 md:flex">
    <div class="flex-none text-gray-700 mb-6 mx-6 md:w-1/3 md:max-w-xs lg:mr-16 md:ml-10">
      <div class="md:flex md:justify-center">
        <div class="border border-gray-300 rounded md:fixed md:mt-16 md:ml-6">
    ...
    <div v-if="markedToggle" class="flex flex-wrap mx-6 md:mx-4 md:w-2/3 ">
      <student-card v-for="student in markedStudents" v-bind:student="student" :key="student.id" />
    </div>
    <div v-else-if="!markedToggle" class="flex flex-wrap mx-6 md:mx-4 md:w-2/3 ">
